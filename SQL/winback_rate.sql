...
DECLARE REPORT_END_DATE DATE DEFAULT DATE_SUB(
    DATE_TRUNC(
        DATE_ADD(REPORT_START_DATE, INTERVAL 1 MONTH),
        MONTH
    ),
    INTERVAL 1 DAY
);
DECLARE SIGNUP_LAST_DAY DATE DEFAULT DATE_SUB(
    DATE_TRUNC(
        DATE_ADD(REPORT_START_DATE, INTERVAL 1 MONTH),
        MONTH
    ),
